...
{
    public partial class FAddS : Form
    {
        ...
        private async void FAddS_Load(object sender, EventArgs e)
        {
            ...
            sda = new SqlDataAdapter(@"SELECT * FROM [AddServ]", sqlConnection);
            dt = new DataTable();
            sda.Fill(dt);
        ...
        {
            FEditAddS fEditAddS = new FEditAddS();
            fEditAddS.Show();
        }
        ...
        private async void button3_Click(object sender, EventArgs e)
        {
            ...
            if (comboBox1.Text == "Названию")
            {
                string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\VisualStudio\KursHolidays\KursHolidays\Database.mdf;Integrated Security=True";
                sqlConnection = new SqlConnection(connectionString);
                sda = new SqlDataAdapter(@"SELECT * FROM [AddServ] ORDER BY Name_serv", sqlConnection);
                dt = new DataTable();
                sda.Fill(dt);
                dataGridView1.DataSource = dt;
            }
            else if (comboBox1.Text == "Цене")
            {
                string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\VisualStudio\KursHolidays\KursHolidays\Database.mdf;Integrated Security=True";
                sqlConnection = new SqlConnection(connectionString);
                sda = new SqlDataAdapter(@"SELECT * FROM [AddServ] ORDER BY Price_serv", sqlConnection);
                dt = new DataTable();
                sda.Fill(dt);
                dataGridView1.DataSource = dt;
            }
            else if (comboBox1.Text == "ID")
            {
                string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\VisualStudio\KursHolidays\KursHolidays\Database.mdf;Integrated Security=True";
                sqlConnection = new SqlConnection(connectionString);
                sda = new SqlDataAdapter(@"SELECT * FROM [AddServ] ORDER BY Id_serv", sqlConnection);
                dt = new DataTable();
                sda.Fill(dt);
                dataGridView1.DataSource = dt;
            }
        ...
        {
            FStatAddS fStatAddS = new FStatAddS();
            fStatAddS.Show();
        }
    }
}
