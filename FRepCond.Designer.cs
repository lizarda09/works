namespace KursHolidays
{
    partial class FRepCond
    {
        ...
        private void InitializeComponent()
        {
            ...
            reportDataSource2.Value = this.ConductBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource2);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "KursHolidays.ReportCond.rdlc";
            ...
            this.Name = "FRepCond";
            this.Text = "Отчет";
            this.Load += new System.EventHandler(this.FRepCond_Load);
